<?php
namespace Naicheframework\Helper;
...
class Convert
{
	public static function whatsapp($phone, $text=null)
	{
		...
		if ($iphone || $android || $palmpre || $ipod || $berry == true)
		{
			...
			return 'https://web.whatsapp.com/send?phone=Y' . $phone . '&text=' . $text;
		}
	}
	/**
    ...
    public static function removeEspecialChars($var, $whitespace=false)
    {
    	...
    	$var = preg_replace("(á|Á|à|À|ã|Ã|â|Â)","a",$var);
